...
public static class InternalMiiManager
{
    ...
    public static byte[] GetMiiDataByClientId(uint clientId)
    {
        ...
        foreach (var block in allMiis)
        {
            ...
            uint thisMiiId = BigEndianBinaryReader.ReadLittleEndianUInt32(block, 0x18);
    ...
    public static uint CreateNewMiiInDb(string initialName)
    {
        ...
        BigEndianBinaryReader.WriteUInt16BigEndian(newMiiBlock, 0x00, header);
        ...
        uint newClientId = GenerateMiiID();
        ...
        BigEndianBinaryReader.WriteUInt16BigEndian(newMiiBlock, 0x20, 0);

        // -- Offset 0x22-0x23: Hair info
        // Fields: hairType (7), hairColor (3), hairPart (1), unknown (5)
        BigEndianBinaryReader.WriteUInt16BigEndian(newMiiBlock, 0x22, 0);
        ...
        BigEndianBinaryReader.WriteUInt32BigEndian(newMiiBlock, 0x24, eyebrows);
        ...
        uint eyes = ((uint)(0 & 0x3F) << 26) |    // eyeType = 0
                    ...
                    ((uint)(0 & 0x1F));          // unknown
        BigEndianBinaryReader.WriteUInt32BigEndian(newMiiBlock, 0x28, eyes);
        ...
        ushort nose = (ushort)(((0 & 0xF) << 12) |  // noseType = 0
                               ...
                               (0));               // unknown = 0
        BigEndianBinaryReader.WriteUInt16BigEndian(newMiiBlock, 0x2C, nose);
        ...
        BigEndianBinaryReader.WriteUInt16BigEndian(newMiiBlock, 0x2E, lip);
        ...
        BigEndianBinaryReader.WriteUInt16BigEndian(newMiiBlock, 0x30, glasses);
        ...
        BigEndianBinaryReader.WriteUInt16BigEndian(newMiiBlock, 0x32, facialHair);
        ...
        ushort mole = (ushort)(((0 & 0x1) << 15) |      // moleOn = 0 (no mole)
                               ...
                               (0));                   // unknown = 0
        BigEndianBinaryReader.WriteUInt16BigEndian(newMiiBlock, 0x34, mole);
    ...
    private static uint GenerateMiiID()
    {
        ...
        int randomByte = random.Next(0x00, 0x81);
        uint id = ((uint)randomByte << 24) | 0x00CA95C5;
        return id;
    }
