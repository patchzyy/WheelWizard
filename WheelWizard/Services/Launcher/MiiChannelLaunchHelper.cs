...
public static class MiiChannelLaunchHelper
{
    ...
    public static async Task LaunchMiiChannel()
    {
        ...
        if (!miiChannelExists)
        {
            // IMPORTANT: If we do enable this again, we should also add translations support for the text here
            ...
            if (downloadQuestion.AwaitAnswer())
            {
                ...
                await DownloadHelper.DownloadToLocation(Endpoints.MiiChannelWAD, MiiChannelPath, "Downloading MiiChannel");
